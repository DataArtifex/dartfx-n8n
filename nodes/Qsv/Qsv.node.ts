    ...
    properties: [
      {
        ...
        options: [
          ...
          },
          {
            name: 'Count (count)',
            value: 'count',
            description: 'Returns a count of the number of records in the CSV data. It has three modes of operation: 1. If a valid index is presen',
            action: 'Count',
          },
          {
          ...
          },
          {
            name: 'Json (json)',
            value: 'json',
            description: 'Convert JSON to CSV. The JSON data is expected to be non-empty and non-nested as either: 1. An array of objects where: A',
            action: 'Json',
          },
          {
            name: 'Jsonl (jsonl)',
          ...
          },
          {
            name: 'Log (log)',
            value: 'log',
            description: 'Logs an MCP tool invocation entry to qsvmcp.log. Only intended for internal use by the This command is used internally b',
            action: 'Log',
          },
          {
          ...
          },
          {
            name: 'Pivotp (pivotp)',
            value: 'pivotp',
            description: 'Pivots or groups CSV data using the Polars engine. PIVOT MODE (with <on-cols>): The pivot operation consists of: - One o',
            action: 'Pivotp',
          },
          {
          ...
          },
          {
            ...
            value: 'profile',
            description: 'Profile a CSV (local path or URL) and emit a `.metadata.json` file carrying five top-level blocks: `dpp`        — inferr',
            action: 'Profile',
          },
          {
            name: 'Prompt (prompt)',
            value: 'prompt',
            description: 'Open a file dialog to pick a file as input or save to an output file. Examples: # Pick a single file as input to qsv sta',
            action: 'Prompt',
          },
          {
            name: 'Pseudo (pseudo)',
