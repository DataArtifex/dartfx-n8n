...
export async function executeViz(
  ...
  try {
    ...
    try {
      const val = this.getNodeParameter('denominatorUnit', itemIndex, false) as boolean;
      if (val) {
    ...
    try {
      const val = this.getNodeParameter('geocodeCountry', itemIndex, false) as boolean;
      if (val) {
    ...
    try {
      const val = this.getNodeParameter('geocodeAdmin1', itemIndex, false) as boolean;
      if (val) {
