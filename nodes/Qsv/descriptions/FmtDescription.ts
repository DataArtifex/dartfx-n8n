...
export const FmtDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    type: "string",
    default: "",
    description: "Additional raw command line arguments to pass to qsv fmt",
    displayOptions: {
      show: {
        operation: ["fmt"],
      },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Use ASCII field/record separators: Unit Separator",
      },
      {
        displayName: "Quote",
        name: "quote",
        type: "string",
        default: "",
        description: "The quote character to use. Must be a single",
      },
      {
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Do not write a newline at the end of the output.",
      },
      {
