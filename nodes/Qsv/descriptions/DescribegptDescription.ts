  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        default: "",
        description:
          "hen the format is JSONSchema, emit additionalProperties as true at the",
      },
      {
        ...
        default: "",
        description:
          "hen the format is JSONSchema, emit format date or date-time for",
      },
      {
      ...
      },
      {
        ...
        default: "",
        description:
          "Write output to <file> instead of stdout. If --format is set to TSV,",
      },
      {
        displayName: "Quiet",
        name: "quiet",
