...
export const DescribegptDescription: INodeProperties[] = [
    ...
    },
    {
      ...
      description: 'Path to a file with additional context about the dataset - e.g. variable/code labels, provenance & domain notes - injected into the prompts as the {{ context }} MiniJinja variable. The file TYPE is',
    },
    {
