...
export const VizDescription: INodeProperties[] = [
    ...
    },
    {
      ...
      description: 'Colorscale for the region fill. One of: viridis (the default),',
    },
    {
      displayName: 'Map',
      name: 'map',
      ...
      description: 'Render on a token-free MapLibre tile basemap (a ChoroplethMap)',
    },
    {
      displayName: 'Geojson',
      name: 'geojson',
      ...
      description: 'Custom region polygons as a local file path or an http(s) URL',
    },
    {
    ...
    },
    {
      ...
      description: 'For point-in-polygon binning: the farthest (in km) an outside',
    },
    {
      ...
      description: 'Maximum number of panels in the Data Schematic. 0 (the default)',
    },
    {
      ...
      description: 'Number of columns in the Data Schematic grid for the per-column',
    },
    {
    ...
    },
    {
      ...
      description: 'For the `viz smart` map panel: when a column holds image URLs',
    },
    {
      displayName: 'Limit',
      name: 'limit',
    ...
    },
    {
      ...
      description: 'Omit the "(NULL)" bar (empty cells) from frequency bar charts.',
    },
    {
      ...
      description: 'Omit the "Other (N)" aggregate bar from frequency bar charts. It',
    },
    {
      displayName: 'Smarter',
      name: 'smarter',
      ...
      description: 'Before building the Data Schematic, run `qsv moarstats --advanced`',
    },
    {
      ...
      description: 'For `smart`, the chart used for the categorical part-to-whole',
    },
    {
      ...
      description: 'Use a describegpt Data Dictionary to guide panel selection from',
    },
    {
    ...
    },
    {
      ...
      description: 'When a usable Data Dictionary is available (per --dictionary), add',
    },
    {
      ...
      description: 'A persistent identifier (PID) for the dataset - typically a full',
    },
    {
