...
export const DatefmtDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    description:
      "Put the transformed values in new column(s) instead of replacing the source column(s). When the selection has multiple columns, pass a comma-separated list of new column names that match the selection count (e.g. --new-column 'open_iso,close_iso' for 'OpenDate,CloseDate'). To rename in place instead, use --rename.",
  },
  {
    displayName: "Rename",
    name: "rename",
  ...
  },
  {
    ...
    description:
      'The resolution to use when parsing Unix timestamps. Valid values are "sec", "milli", "micro", "nano". [default: sec]',
  },
  {
    displayName: "Jobs",
    name: "jobs",
