...
export const ApplyDescription: INodeProperties[] = [
    ...
    },
    {
      ...
      description: '=<string>      The string to use to replace empty values. <column>                    The column/s to check for emptiness.',
    },
    {
      ...
      description: '=<string>        The template to use for the dynfmt operation. See DYNFMT example above for more details.',
    },
    {
    ...
    },
    {
      ...
      description: '=<string>    The string to compare against for replace & similarity operations. Also used with numtocurrency operation to specify currency symbol.',
    },
    {
      displayName: 'Jobs',
      name: 'jobs',
