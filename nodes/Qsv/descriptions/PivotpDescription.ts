...
export const PivotpDescription: INodeProperties[] = [
    ...
    },
    {
      ...
      description: 'Maintain output order: preserve input column order in pivot mode,',
    },
    {
    ...
    },
    {
      ...
      description: 'Append a grand total row summing all numeric non-index columns.',
    },
    {
      ...
      description: 'Insert subtotal rows after each group in the first index column.',
    },
    {
