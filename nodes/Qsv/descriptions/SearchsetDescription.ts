...
export const SearchsetDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    default: "",
    description:
      "Additional raw command line arguments to pass to qsv searchset",
    displayOptions: {
      show: {
        operation: ["searchset"],
      },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "When --flag is enabled, only rows that match are",
      },
      {
        ...
        type: "string",
        default: "",
        description: "When --flag-matches-only is enabled, output the rows",
      },
      {
        displayName: "Quick",
        name: "quick",
      ...
      },
      {
        ...
        type: "boolean",
        default: false,
        description: "Return number of matches, number of rows with matches,",
      },
      {
