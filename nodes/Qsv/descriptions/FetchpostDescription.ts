...
export const FetchpostDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    description: 'Additional raw command line arguments to pass to qsv fetchpost (Docs: https://github.com/dathere/qsv/blob/master/docs/help/fetchpost.md)',
    displayOptions: {
      show: {
        operation: ['fetchpost'],
      },
  ...
  },
  {
    ...
    },
    {
      ...
      type: 'boolean',
      default: false,
      description: 'Use Redis to cache responses. It connects to "redis://127.0.0.1:6379/2" with a connection pool size of 20, with a TTL of 28 days, and a cache hit NOT renewing an entry\'s TTL. Adjust the QSV_FP_REDIS_CONNSTR, QSV_REDIS_MAX_POOL_SIZE, QSV_REDIS_TTL_SECS & QSV_REDIS_TTL_REFRESH respectively to change Redis settings. A QSV_REDIS_TTL_SECS of 0 disables expiration (entries cached indefinitely).',
    },
    {
      displayName: 'Report',
      name: 'report',
